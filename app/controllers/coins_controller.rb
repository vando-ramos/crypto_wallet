class CoinsController < ApplicationController
  ...
  private
    def set_consensus_mechanism_options
      @consensus_mechanism_options = ConsensusMechanism.all.pluck(:description, :id)
    end
    ...
    def coin_params
      params.require(:coin).permit(:description, :acronym, :url_image, :consensus_mechanism_id)
    end
end
